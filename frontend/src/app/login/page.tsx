  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8 border border-slate-100">
        ...
        <p className="text-center text-slate-500 mb-6 text-sm">Sign in to Luwinga Career Guidance</p>
        <p className="text-sm text-slate-600 bg-blue-50 border border-blue-100 rounded-xl p-4">
          Authentication UI will connect to the Laravel API. For now, use the{" "}
          <a href={`${apiUrl}/login`} className="text-blue-600 font-medium hover:underline">legacy login page</a>{" "}
