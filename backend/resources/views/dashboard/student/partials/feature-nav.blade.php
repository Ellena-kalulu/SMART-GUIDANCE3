<nav class="bg-white rounded-2xl border border-blue-100 shadow-md p-3 space-y-1">
    ...
    @foreach($links as $link)
        ...
        <a href="{{ route($link['route']) }}"
           class="flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all {{ $active ? 'bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-md shadow-blue-600/25' : 'text-black/60 hover:bg-blue-50 hover:text-blue-700 border border-transparent hover:border-blue-100' }}">
